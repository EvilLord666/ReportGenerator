...
VALUES (N'25FB9FF7-7259-48CD-86E3-F6F298F2FE91', 'Иван', 'Иванов', 21, 1, N'B9B08522-D89B-486A-BFE5-7694C6AE2D06');
INSERT INTO [dbo].[Citizen] ([Id], [FirstName], [LastName], [Age], [Sex], [CityId])
VALUES (N'29FDF443-A60E-49F2-94E3-071BAF02313A', 'Алексей', 'Козлов', 34, 1, N'B9B08522-D89B-486A-BFE5-7694C6AE2D06');
INSERT INTO [dbo].[Citizen] ([Id], [FirstName], [LastName], [Age], [Sex], [CityId])
VALUES (N'2D284B32-C3C2-4DEF-B868-748859AC7F39', 'Петр', 'Петров', 32, 1, N'B9B08522-D89B-486A-BFE5-7694C6AE2D06');
INSERT INTO [dbo].[Citizen] ([Id], [FirstName], [LastName], [Age], [Sex], [CityId])
VALUES (N'FA8F82F0-7B8F-459A-A5BD-57F2BFBB3FAD', 'Елена', 'Головач', 19, 0, N'B9B08522-D89B-486A-BFE5-7694C6AE2D06');
INSERT INTO [dbo].[Citizen] ([Id], [FirstName], [LastName], [Age], [Sex], [CityId])
VALUES (N'A660D90A-BD41-49B5-B42D-9020532501D3', 'Ольга', 'Вялова', 44, 0, N'B9B08522-D89B-486A-BFE5-7694C6AE2D06');

-- Nijniy Tagil citizens
INSERT INTO [dbo].[Citizen] ([Id], [FirstName], [LastName], [Age], [Sex], [CityId])
VALUES (N'1861B600-658F-4F18-914E-939DB1317CCF', 'Роман', 'Барашков', 49, 1, N'B9B08522-D89B-486A-BFE5-7694C6AE2D06');
INSERT INTO [dbo].[Citizen] ([Id], [FirstName], [LastName], [Age], [Sex], [CityId])
VALUES (N'1DA29BFC-62D5-4247-AD35-70F7A3467969', 'Татьяна', 'Трололошина', 30, 0, N'B9B08522-D89B-486A-BFE5-7694C6AE2D06');
INSERT INTO [dbo].[Citizen] ([Id], [FirstName], [LastName], [Age], [Sex], [CityId])
VALUES (N'D43B3021-D52F-43F5-AED6-9661F6C1C35E', 'Екатерина', 'Кракозябрина', 22, 0, N'B9B08522-D89B-486A-BFE5-7694C6AE2D06');

-- Pervoyralsk citizen
INSERT INTO [dbo].[Citizen] ([Id], [FirstName], [LastName], [Age], [Sex], [CityId])
VALUES (N'BA87DCB9-8A5D-40B5-93A5-13C4E65F008F', 'Юра', 'Наркоманов', 33, 1, N'BA2B81C2-AE3B-4AD3-8502-73050CAB6D03');
INSERT INTO [dbo].[Citizen] ([Id], [FirstName], [LastName], [Age], [Sex], [CityId])
VALUES (N'FC40831D-C5AF-46D0-89D3-EFBB004D4804', 'Татьяна', 'Трололошина', 30, 0, N'BA2B81C2-AE3B-4AD3-8502-73050CAB6D03');
INSERT INTO [dbo].[Citizen] ([Id], [FirstName], [LastName], [Age], [Sex], [CityId])
VALUES (N'826A6FA7-34D6-46C9-8B47-3DA50207E168', 'Екатерина', 'Кракозябрина', 22, 0, N'BA2B81C2-AE3B-4AD3-8502-73050CAB6D03');

-- Chelyabinsk citizen
INSERT INTO [dbo].[Citizen] ([Id], [FirstName], [LastName], [Age], [Sex], [CityId])
VALUES (N'CF9C5B97-7D36-432B-B427-14862FF4E9CE', 'Денис', 'Казаков', 14, 1, N'F4CB1315-E721-46F4-AF86-42C1E85917D3');
INSERT INTO [dbo].[Citizen] ([Id], [FirstName], [LastName], [Age], [Sex], [CityId])
VALUES (N'F689341E-5D1D-4AE9-997C-ED5A19B05FDA', 'Вячеслав', 'Семенов', 27, 1, N'F4CB1315-E721-46F4-AF86-42C1E85917D3');
INSERT INTO [dbo].[Citizen] ([Id], [FirstName], [LastName], [Age], [Sex], [CityId])
VALUES (N'123D576A-0016-4353-9CDC-A19DE8F9E966', 'Марина', 'Олошина', 30, 0, N'F4CB1315-E721-46F4-AF86-42C1E85917D3');
INSERT INTO [dbo].[Citizen] ([Id], [FirstName], [LastName], [Age], [Sex], [CityId])
VALUES (N'C2761BFE-6969-4C5E-A482-77EADA3FD36B', 'Маша', 'Козлова', 25, 0, N'F4CB1315-E721-46F4-AF86-42C1E85917D3');